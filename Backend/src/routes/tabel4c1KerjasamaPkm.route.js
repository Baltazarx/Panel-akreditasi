...
// 1. Impor 8 fungsi dari controller 4C1 (termasuk restore)
import {
...
router.post('/:id/restore', requireAuth, permit(resourceKey, 'U'), restoreTabel4c1KerjasamaPkm);
