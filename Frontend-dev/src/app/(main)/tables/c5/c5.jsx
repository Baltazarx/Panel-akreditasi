...
export default function C5WithTopNav() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      localStorage.setItem("c5_active_tab", activeKey);
    }
  }, [activeKey]);
  ...
  if (tabs.length === 0 && role) {
    return <div className="p-4 text-center text-slate-600">Tidak ada tabel C5 yang tersedia untuk peran Anda ({role}).</div>;
  }
