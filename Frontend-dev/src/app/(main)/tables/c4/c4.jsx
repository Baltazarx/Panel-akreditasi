...
export default function C4WithTopNav() {
  ...
  const [activeKey, setActiveKey] = useState("4a1"); // default ke 4A-1

  // Baca tab dari hash / localStorage jika ada (#tab=4a1)
  useEffect(() => {
  ...
  const Active = tabs.find(t => t.key === activeKey)?.Component || (tabs[0]?.Component || Tabel4A1);
