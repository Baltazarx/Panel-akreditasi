...
import { FiEdit2, FiTrash2, FiRotateCw, FiXCircle, FiMoreVertical, FiChevronDown, FiHome, FiShield, FiDownload, FiChevronLeft, FiChevronRight } from 'react-icons/fi';
...
function DataTable({
  ...
  // filteredRows logic moved to parent
