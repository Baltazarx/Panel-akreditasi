    ...
    return (
      <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-gray-200">
              ...
              <button className="px-5 py-2.5 rounded-lg bg-[#0384d6] hover:bg-[#043975] text-white shadow-md disabled:opacity-50 disabled:cursor-not-allowed" disabled={loading} type="submit">Simpan</button>
          </div>
      </form>
    );
  }
