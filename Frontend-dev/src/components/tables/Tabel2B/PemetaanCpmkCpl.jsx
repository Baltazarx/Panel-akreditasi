...
import CpmkCRUD from "./CpmkCRUD";
import CplCRUD from "./CplCRUD";

// ============================================================
// PEMETAAN CPMK vs CPL (MATRIX EDITABLE)
// ============================================================
export default function PemetaanCpmkCpl({ role, refreshTrigger, onDataChange, maps }) {
      ...
      <div className="mb-8 space-y-8">
        <div>
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-base font-bold text-slate-700 uppercase tracking-wider">Data CPMK</h3>
            <span className="text-xs px-2 py-1 bg-slate-100 text-slate-500 rounded border border-slate-200">Read Only</span>
          </div>
          <CpmkCRUD role={role} maps={maps} onDataChange={() => { }} refreshTrigger={refreshTrigger} />
        </div>
