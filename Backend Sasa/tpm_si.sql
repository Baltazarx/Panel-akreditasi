...
INSERT INTO `cpl` VALUES (1,4,'CPL-A','Menguasai algoritma',NULL,NULL),(2,4,'CPL-B','Menerapkan model ML',NULL,NULL),(3,4,'CPL-C','Mengelola & visualisasi data',NULL,NULL);
...
DROP TABLE IF EXISTS `map_cpl_mk`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `map_cpl_mk` (
  `id_cpl` int NOT NULL,
  `id_mk` int NOT NULL,
  PRIMARY KEY (`id_cpl`,`id_mk`),
  KEY `id_mk` (`id_mk`),
  CONSTRAINT `map_cpl_mk_ibfk_1` FOREIGN KEY (`id_cpl`) REFERENCES `cpl` (`id_cpl`) ON DELETE CASCADE,
  CONSTRAINT `map_cpl_mk_ibfk_2` FOREIGN KEY (`id_mk`) REFERENCES `mata_kuliah` (`id_mk`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `map_cpl_mk` WRITE;
/*!40000 ALTER TABLE `map_cpl_mk` DISABLE KEYS */;
INSERT INTO `map_cpl_mk` VALUES (1,1),(2,2);
/*!40000 ALTER TABLE `map_cpl_mk` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `map_cpl_pl` VALUES (1,1),(3,1),(1,2);
...
INSERT INTO `mata_kuliah` VALUES (1,4,'IF-101','Algoritma & Pemrograman',3,1,NULL,NULL),(2,4,'IF-401','Dasar Kecerdasan Buatan',3,5,NULL,NULL);
...
INSERT INTO `profil_lulusan` VALUES (1,4,'PL-1','Analis Data',NULL,NULL),(2,4,'PL-2','Pengembang AI',NULL,NULL);
...
INSERT INTO `unit_kerja` VALUES (1,'Ketua STIKOM',NULL,NULL),(2,'Wakil Ketua I',NULL,NULL),(3,'Wakil Ketua II ',NULL,NULL),(4,'Prodi TI',NULL,NULL),(5,'Prodi MI',NULL,NULL),(6,'ALA',NULL,NULL),(7,'PMB',NULL,NULL),(8,'Kemahasiswaan',NULL,NULL),(9,'TPM',NULL,NULL),(10,'Kepegawaian',NULL,NULL),(11,'Sarpras',NULL,NULL);
...
INSERT INTO `users` VALUES (1,1,'waket1','$2b$10$zPvCSBBYV0RNbGKRT.bW7OtKVTLwXUSMstPsZw6t0tjFuZN73sJma',2,'WAKET-1',1,'2025-08-21 23:54:41','2025-09-29 09:31:32',NULL,NULL),(2,3,'waket2','$2a$10$9diXzH2UIw9kVoyQuxaN/u/7QvBgS/9BajNAt84IvaEN41jxV5zqG',3,'waket-2',1,'2025-08-21 23:54:41','2025-08-21 23:54:41',NULL,NULL),(3,2,'prodi_if','$2a$10$9diXzH2UIw9kVoyQuxaN/u/7QvBgS/9BajNAt84IvaEN41jxV5zqG',4,'prodi',1,'2025-08-21 23:54:41','2025-09-30 11:53:05',NULL,NULL),(4,8,'lppm_user','$2a$10$9diXzH2UIw9kVoyQuxaN/u/7QvBgS/9BajNAt84IvaEN41jxV5zqG',4,'lppm',1,'2025-08-21 23:54:41','2025-08-21 23:54:41',NULL,NULL),(5,5,'kepegawaian_user','$2a$10$9diXzH2UIw9kVoyQuxaN/u/7QvBgS/9BajNAt84IvaEN41jxV5zqG',6,'kepegawaian',1,'2025-08-21 23:54:41','2025-08-21 23:54:41',NULL,NULL),(6,7,'tpm_user','$2a$10$9diXzH2UIw9kVoyQuxaN/u/7QvBgS/9BajNAt84IvaEN41jxV5zqG',5,'tpm',1,'2025-08-21 23:54:41','2025-09-29 08:12:54','2025-09-29 15:12:54',1);
...
-- Dump completed on 2025-10-10 15:52:26
